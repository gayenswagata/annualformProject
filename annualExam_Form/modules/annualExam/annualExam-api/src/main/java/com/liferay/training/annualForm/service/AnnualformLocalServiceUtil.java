...
/**
 * Provides the local service utility for Annualform. This utility wraps
 * <code>com.liferay.training.annualForm.service.impl.AnnualformLocalServiceImpl</code> and
 ...
 * @generated
 */
public class AnnualformLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.liferay.training.annualForm.service.impl.AnnualformLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static Annualform addAnnualform(Annualform annualform) {
		return getService().addAnnualform(annualform);
	}
	 ...
	 */
	public static Annualform createAnnualform(long annualformId) {
		return getService().createAnnualform(annualformId);
	}
	 ...
	 */
	public static Annualform deleteAnnualform(Annualform annualform) {
		return getService().deleteAnnualform(annualform);
	}
	 ...
	 */
	public static Annualform deleteAnnualform(long annualformId)
		throws PortalException {

		return getService().deleteAnnualform(annualformId);
	}
	...
	public static Annualform fetchAnnualform(long annualformId) {
		return getService().fetchAnnualform(annualformId);
	}
	 ...
	 * @throws PortalException if a annualform with the primary key could not be found
	 */
	public static Annualform getAnnualform(long annualformId)
		throws PortalException {

		return getService().getAnnualform(annualformId);
	}
	 ...
	 */
	public static List<Annualform> getAnnualforms(int start, int end) {
		return getService().getAnnualforms(start, end);
	}
	 ...
	 */
	public static int getAnnualformsCount() {
		return getService().getAnnualformsCount();
	}
	 ...
	 */
	public static Annualform updateAnnualform(Annualform annualform) {
		return getService().updateAnnualform(annualform);
	}

	public static AnnualformLocalService getService() {
		return _service;
	}

	private static volatile AnnualformLocalService _service;
